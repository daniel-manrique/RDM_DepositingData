...
Define [directory structures, file formats, and naming conventions]{style="text-decoration: underline;"}.
...
::: {style="text-align: center;"}
![From https://www.projecttier.org/](images/files.png){width=80%}
:::
::::

## Building a comprenhensive dataset
